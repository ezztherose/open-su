...
{   
    ...
    public class FakturaregisterRepository : GenericRepository<Fakturaregister>, IFakturaregisterRepository
    {
        public FakturaregisterRepository(DatabaseContext context) : base(context)
        {
